...
const RemoveBackground = () => {
      ...
      const handleDownload = async (url, filename = "background_removed.png") => {
        try {
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        from-[#533204] to-[#FF4938] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer'>
          {
        ...
        <div className='flex items-center gap-3'>
        ...
        </div>
         {
          ...
          <div className="relative mt-3">
            <img src={content} alt="image" className='w-full h-full rounded'/>
