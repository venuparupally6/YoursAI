  ...
  return (
    ...
    >
      <div className="text-center mb-6">
        ...
        mx-auto leading-[1.2]">
          Create your amazing content <br/> with
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-300/90 to-purple-400/80 drop-shadow-md backdrop-blur-sm"> AI Tools</span> 
        </h1>
        <p className="mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl m-auto max-sm:text-xs
        text-gray-600">Transform your content creation with our suite of premium
        AI tools. Write articles, generate images, and enhance your workflow.</p>
      </div>
